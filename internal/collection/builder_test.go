...
func newRecordingJointStore() *recordingJointStore {
	return &recordingJointStore{published: make(chan struct{}, 1)}
}

func (s *recordingJointStore) Publish(ctx context.Context, serviceID, indicatorID int, build func(io.Writer) error) (int64, bool, error) {
